...
<body>
    <div id="wrapper">
        <div id="header">
            My Chat
            <div style="font-size: 2rem; font-family:myFont;padding: 10px 0">Log in</div>
        </div>
        <form action="/" id="myform">
            ...
            <br>
            <div style="text-align:center"><a href="signup.php">Don't have an account? Sign up</a></div>
        </form>
    </div>
